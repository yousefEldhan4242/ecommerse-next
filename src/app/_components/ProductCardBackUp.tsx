...
const ProductCard = ({
  ...
  const renderStars = () => {
    ...
    for (let i = 0; i < 5; i++) {
      if (i < filledStars) {
        stars.push(<Image src="/starpng.png" alt="" key={i} width={100} height={100}/>);
      } else if (i === filledStars && halfStar) {
        // Create Half Star
        stars.push(<Image src="/star-half-filled.png" alt="" key={i} width={100} height={100}/>);
      } else {
        // reate Empty Star
        stars.push(<Image src="/empty-star.png" alt="" key={i} width={100} height={100}/>);
      }
    }
    return stars;
  };
